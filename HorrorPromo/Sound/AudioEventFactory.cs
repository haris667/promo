...
namespace Sound
{
    ...
    //в этом проекте
    public class AudioEventFactory : MonoBehaviour
    {
        [SerializeField] 
        ...
        public GameObject Create(EventSoundSettings soundSettings)
        {
        ...
        private void ConfigureAudioSource(AudioSource source, EventSoundSettings settings)
        {
